...
public class Goal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConstraintLayout layout = findViewById(R.id.layoutGoal);

        ImageView img_goal= (ImageView) findViewById(R.id.img_goal);
        TextView nome_goal= (TextView) findViewById(R.id.nome_goal);
        TextView descr_goal=findViewById(R.id.descr_goal);
